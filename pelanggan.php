...
$pelanggan = mysqli_query($connect, "SELECT * FROM tb_pelanggan");
                                                ...
                                                <table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%;">
                                                    <thead>
                                                        <tr role="row">
                                                            ...
                                                            <th class="sorting sorting_asc" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 161px;">No Telp</th>
                                                            <th class="sorting sorting_asc" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 161px;">Status</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        <?php
                                                        $no = 1;
                                                        while ($tampil = mysqli_fetch_array($pelanggan)) { ?>
                                                            <tr>
                                                                <td><?php echo $no++; ?></td>
                        ...
                        <div class="modal-body">
                            <form method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="no_tlp" type="text" class="form-control" id="formGroupExampleInput" placeholder="Example input" required>
                                </div>
                                <div class="form-group">
